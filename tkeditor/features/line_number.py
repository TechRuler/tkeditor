...
class LineNumber(Canvas):
    def __init__(self, master, **kwarg):
        ...
        self.config(width=self.width, bg=kwarg.get("line_number_bg") if kwarg.get("line_number_bg") else kwarg.get("bg","white"))
    ...
    def redraw(self):
        ...
        while True:
            ...
            self.create_text(x, y, anchor='nw', text=line_number, font=self.font, fill=self.fill, tags=('line_number'))
